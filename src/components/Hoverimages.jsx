...
//         "/imgs/active/16.jpg",
    ...
    >
      <section  className="grid  marqueetextimg h-[100vh] w-full place-content-center bg-black">
        <p className="flex skilltext  gap-2 text-[25vw] font-[font1] font-bold uppercase text-white">
